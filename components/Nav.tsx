...
/** Desktop-only top navigation bar (hidden on mobile — BottomNav takes over) */
export function Nav() {
  const path = usePathname();
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-slate-800 bg-slate-950/95 backdrop-blur-md hidden md:block">
